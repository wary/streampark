...
import org.apache.flink.kubernetes.kubeclient.deployment.UdClusterClientFactory;
import org.apache.flink.kubernetes.utils.Constants;
import org.apache.flink.util.AbstractID;

import static org.apache.flink.util.Preconditions.checkNotNull;

public class K8sIngressClusterClientFactory extends KubernetesClusterClientFactory implements UdClusterClientFactory {
    ...
    public KubernetesClusterDescriptor createClusterDescriptor(Configuration configuration) {
        ...
        return new K8sIngressClusterDescriptor(
            configuration,
