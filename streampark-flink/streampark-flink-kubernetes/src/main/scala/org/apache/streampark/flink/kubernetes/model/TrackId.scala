...
object TrackId {
  def onSession(
    ...
    this(FlinkK8sDeployMode.SESSION, namespace, clusterId, appId, jobId, groupId, k8sConf, properties)
  }
  ...
  def onApplication(
      ...
      k8sConf: String,
      properties: Properties): TrackId = {
    this(FlinkK8sDeployMode.APPLICATION, namespace, clusterId, appId, jobId, groupId, k8sConf, properties)
  }
}
